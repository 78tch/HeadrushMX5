...
- 残課題２：環境によっては、モバイルバッテリーを使用しても、ノイズがひどいことがあった。音量が小さかったためAmpのGAINなどを大きくしたことも関係しているかもしれない。対応方法を検討したい。
...
なお、モデルごとに、設定に名前を付けて保存し、呼び出すことができる。これを「プリセット」と呼ぶ。
  
### 2-2. Rigsフォルダ
[Rigs 一覧](https://github.com/78tch/HeadrushMX5/blob/master/Rigs.md)  
MX5のRigは、他メーカーのマルチでいうところのいわゆるプリセットのことで、ペダルボードを組んで設定をしたものに、名前を付けて保存したもの。  
...
サブフォルダのなかに入れても認識されるので、適宜サブフォルダに入れたほうが整理しやすい。

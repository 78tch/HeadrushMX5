...
4. USBオーディオ設定：サンプルレート：USBオーディオインターフェイスの音は、DAW側でGainが固定となって大きくできないのに音量が小さいので、使いづらい。USBからの音を最終的にCD（44.1kHz）にするのであれば、ここも「44.1」にしておけばよいかもしれないが、CDにしないのであれば、最高音質「96.0」にすればよいし、そもそも使わないのであれば、気にしなくてもよい。
